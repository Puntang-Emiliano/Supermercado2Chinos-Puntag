...
{
    public partial class FrmInformeCompras : Form
    {
        public FrmInformeCompras()
        {
            InitializeComponent();
        }

        private void FrmInformeCompras_Load(object sender, EventArgs e)
        {
        ...
        private void btnbuscarresultado_Click(object sender, EventArgs e)
        {
            ...
            foreach (InformeCompra item in lista)
            {
        ...
        private void btnexportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("InformeCompras_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
