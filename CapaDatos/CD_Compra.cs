...
namespace CapaDatos
{
    public class CD_Compra
    {
        public int ObtenerCorrelativo ()
        {
            ...
            using (SqlConnection oconexion = new SqlConnection(Conexion.cadena))
            {
                try
                {
                    ...
                    idcorrelarivo = Convert.ToInt32(cmd.ExecuteScalar());
        ...
        {
            List<Detalle_Compra> _lista = new List<Detalle_Compra>();
            try
            {
            ...
            {
                _lista = new List<Detalle_Compra>();
            }
            return _lista;
        }
